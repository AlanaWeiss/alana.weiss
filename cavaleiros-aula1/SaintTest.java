...
public class SaintTest{
    ...
    public void deveSerPossivelAlterarGenero()throws Exception {
        Saint jabu = new Saint("Dante", new Armadura(new Constelacao("Cisne"), Categoria.BRONZE));
   ...
   //     assertEquals(-900,dante.getVida(),0.01);
    ...
    public void criarSaintNasceCom5SentidosDespertados()throws Exception {
        BronzeSaint dante = new BronzeSaint("Dante", new Armadura(new Constelacao("Cisne"), Categoria.BRONZE));
        assertEquals(5, dante.getQtdSentidosDespertados());
    }
    
    @Test
    public void criarSaintOuroNasceCom7Sentidos()throws Exception {
        GoldSaint dante = new GoldSaint("Dante", new Armadura(new Constelacao("Câncer"), Categoria.OURO));
        assertEquals(7, dante.getQtdSentidosDespertados());
    }
    
    @Test
    public void criarSaintPrataNasceCom6Sentidos()throws Exception {
        SilverSaint dante = new SilverSaint("Dante", new Armadura(new Constelacao("Cisne"), Categoria.PRATA));
    ...
    public void perderTodaAVidaDeixaStatusMorto()throws Exception {
        Saint dante = new Saint("Dante", new Armadura(new Constelacao("Virgem"), Categoria.OURO));
        dante.perderVida(100);
