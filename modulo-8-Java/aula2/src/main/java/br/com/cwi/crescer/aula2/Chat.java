...
import br.com.cwi.lista1.ExercicioString;
import br.com.cwi.lista1.StringUtils;
...
public class Chat {
   ...
   private static final StringUtils STRING_UTILS = new ExercicioString();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@alanaWeiss"};
        }
